<template>
	<view>
		<loanDetail :isForm='true' :formId="businessKey"></loanDetail>
		<!-- 操作按钮 -->
...
<script>
	import loanDetail from '@/pages/business/loan/loanDetail'
	import { getLoan } from "@/api/demo/loan";
	export default {
		name: 'loanForm',
		props: {
		...
		methods: {
			...
			/** 提交按钮 */
			submitForm() {
				getLoan(this.businessKey).then(response => {
					this.taskVariables = {
