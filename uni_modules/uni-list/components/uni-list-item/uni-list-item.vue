<template>
	...
	<cell>
		...
		<view :class="{ 'uni-list-item--disabled': disabled }"
			...
			<view v-if="!isFirstChild" class="border--left" :class="{ 'uni-list--border': border }" :style=" '--uni_border_color:'+ uni_border_color "></view>
...
<style lang="scss">
	...
	$uni-border-color: var(--uni_border_color,red);
